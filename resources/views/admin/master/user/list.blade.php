        ...
        <div class="modal-content">
            ...
            @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Email: </label>
                        <input type="text" class="form-control" name="email" placeholder="alamat@email.com" required>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Email: </label>
                        <input type="text" value="{{ $d->email }}" class="form-control" name="email" placeholder="alamat@email.com" required>
                    </div>
                    <div class="form-group">
                        <label>Password: </label>
                        <input type="text" class="form-control" name="password" placeholder="password" required>
